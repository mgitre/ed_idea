...
CITATION_QA_TEMPLATE = PromptTemplate(
    "Please provide an in-depth answer based solely on the provided sources. "
    "When referencing information from a source, "
    "cite the appropriate source(s) using their corresponding numbers. "
    "Every answer should include at least one source citation. "
    "Only cite a source when you are explicitly referencing it. "
    "Only cite sources as such: [1], [2], [3], etc. "
    ...
    "do not answer the question. Indicate that you do not have enough information. "
    "Please aim to be as informative and nuanced as possible. "
    "Don't worry about the length of your answer. "
    "For example:\n"
    "Source 1:\n"
